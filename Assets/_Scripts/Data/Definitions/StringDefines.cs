namespace Assets._Scripts.Data.Definitions
{
    public static class StringDefines
    {
        ...
        public const string BuildObjectParameterSelectorKey = "BuildObjectParameter";
        ...
        public const string BuildObjectsListSelectorKey = "BuildObjectList";
        ...
        public const string EmployeeSelectorKey = "Employee";
        public const string GuestSelectorKey = "Guest";
